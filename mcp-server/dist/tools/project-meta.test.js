...
const { mockFrom, mockGetProjectId } = vi.hoisted(() => {
    ...
    mockFrom._mockSelect = mockSelect;
    mockFrom._mockEq = mockEq;
    mockFrom._mockOrder = mockOrder;
    mockFrom._mockSingle = mockSingle;
...
//# sourceMappingURL=project-meta.test.js.map